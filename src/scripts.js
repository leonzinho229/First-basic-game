...
// top -> number
// left -> number
board.createItem({ item: 'trap', top: TILE_SIZE * 3, left: TILE_SIZE * 9 });
board.createItem({ item: 'trap', top: TILE_SIZE * 6, left: TILE_SIZE * 15 });
board.createItem({ item: 'trap', top: TILE_SIZE * 9, left: TILE_SIZE * 3 });
board.createItem({ item: 'trap', top: TILE_SIZE * 11, left: TILE_SIZE * 11 });
...
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 1 });
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 3 });
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 5 });
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 7 });
...
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 17 });
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 19 });
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 11 });
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 12 });
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 13 });
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 14 });
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 15 });
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 16 });
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 17 });
board.createEnemy({ top: TILE_SIZE * 5, left: TILE_SIZE * 18 });
